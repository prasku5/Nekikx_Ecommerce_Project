...
import com.aurorion.aurorionbackend.common.ApiResponse;
...
public class ExceptionHandlerAdvice {
	...
	public ResponseEntity<ApiResponse> conflict(DataIntegrityViolationException ex){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(Boolean.FALSE, message, message), HttpStatus.CONFLICT);
	}
...
//	}
	...
	public ResponseEntity<ApiResponse> validationException(ValidationException ex){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(false, message, message), HttpStatus.UNPROCESSABLE_ENTITY);
	}
	...
	public ResponseEntity<ApiResponse> methodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex){
		...
		String message = ex.getMessage();
		return new ResponseEntity<ApiResponse>(new ApiResponse(false, message, message), HttpStatus.INTERNAL_SERVER_ERROR);
	}
